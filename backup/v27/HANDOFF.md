...
| **v45（当前）** | 同 v41 | 同 v41 | 1.62s | 同 v44 | 用户要求：HOLD/Slide 入场改为严格 45° 对角。slide-TR-to-BL 起点 `translate(2400px,-1500px)` → `translate(2400px,-2400px)`、slide-BL-to-TR 起点 `translate(-2400px,1500px)` → `translate(-2400px,2400px)`（dx:dy 1:1） |
