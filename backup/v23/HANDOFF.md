...
| **v42（当前）** | 同 v41 | 同 v41 | 1.62s | 1.88s | 用户纠正：chip 出场原本有"先回往内收一点再往外放大"，恢复 chip-out keyframes 0%(1)→30%(0.82)→50%(2.2)→70%(3.4)→85%(4.2,op0.05)→100%(4.6,op0)。出场时序对齐 ref：t-exit-chip 1.67→1.62s、dur 0.36→0.42s，让 chip 内收@f105、放大@f110、全消@f124，与 ref 节奏对齐 |
